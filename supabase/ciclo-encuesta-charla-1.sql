...
values
  ('c1-equipo', 1, 1, 'opcion',
   ...
   'Lo que ves estos días, sin pensarlo mucho.',
  ...
  ('c1-esfuerzo', 1, 2, 'opcion',
   ...
   'La que te deja más cansado al final del día.',
  ...
  ('c1-ayuda', 1, 3, 'opcion',
   ...
   'Una sola: la que más falta te hace hoy.',
  ...
  ('c1-foco', 1, 4, 'opcion',
   ...
   'En un día común, no en el mejor de todos.',
